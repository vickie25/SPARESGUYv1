      ...
      <Container>
        <Row className="my-3">
          ...
          <Col md={9}>
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
              <Link to="/shop" style={{ color: '#DAA520' }}>Shop</Link>
              <div className="me-auto"></div>
              <Link to="/All products" style={{ color: '#DAA520' }}>All products</Link>
            </div>
            ...
            <Row>
              {currentProducts.map((product) => (
                <Col lg={4} md={6} sm={12} className="mb-4" key={product._id}>
                  <Card style={{ height: '400px', position: 'relative' }}> {/* Adjust the height as needed */}
                    {isInWishlist(product._id) ? (
                      <MdFavorite
                    ...
                    <Button
                      variant="primary"
                      style={{
                        position: 'absolute', bottom: '10px', width: '90%', left: '5%', backgroundColor: '#DAA520', color: 'black', borderColor: '#DAA520'
                      }}
                      onClick={() => addToCart({ ...product, quantity: 1 })}
                    >
                      Add to Cart
